...
shared evaluation protocol, with a fusion stage planned once the individual
modalities are complete.

| Modality | Status |
|---|---|
| **Video** — facial Action Units | complete |
| **Audio** | in progress |
| **Text** | in progress |
| **Fusion** | planned |
...
Macro F1 is the headline metric rather than accuracy: with 24% of participants
in the positive class, a model that predicts "not depressed" for everyone
reaches 76% accuracy while detecting nobody.
